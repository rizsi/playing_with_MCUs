...
.equ OUT_MASK_COMM_HIGH = 0b00011010
.equ OUT_MASK_COMM_LOW = 0b00011000
.equ OUT_MASK_DDRB_OUT = 0b00000010
...
.def CONST_PULLUPS_MASK = r13
.def CONST_DDRB_OUTPUT = r14
.def ADD_CYCLE0 = r20
.def ADD_CYCLE1 = r21
...
reset:
	LDI ZH, OUT_MASK_COMM_LOW
	mov CONST_PULLUPS_MASK, ZH
	LDI ZH, OUT_MASK_DDRB_OUT
	mov CONST_DDRB_OUTPUT, ZH
...
COMM_STATE_START:	; START - store current value
	...
	out DDRB, CONST_DDRB_OUTPUT    ; Drive COMM line
	rjmp comm_ret
...
COMM_STATE_BYTESHIFT_0:
	out PORTB, CONST_PULLUPS_MASK ; Pull to 0
	sbrc BYTESHIFT_VALUE, 0
	ldi BYTESHIFT_NEXT, OUT_MASK_COMM_LOW
